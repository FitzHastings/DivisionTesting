  ...
  <xsl:template match="page-type">
    <fo:simple-page-master
      ...
      <fo:region-body>
        ...
        <xsl:if test="(@body-margin-left)">
          <xsl:attribute name="margin-left">
            <xsl:value-of select="@body-margin-left"/>
          </xsl:attribute>
        </xsl:if>

        <xsl:if test="(@body-margin-right)">
          <xsl:attribute name="margin-right">
            <xsl:value-of select="@body-margin-right"/>
          </xsl:attribute>
        </xsl:if>

        <xsl:if test="(@body-margin-top)">
          <xsl:attribute name="margin-top">
            <xsl:value-of select="@body-margin-top"/>
          </xsl:attribute>
        </xsl:if>

        <xsl:if test="(@body-margin-bottom)">
          <xsl:attribute name="margin-bottom">
      ...
      <fo:region-before>
        ...
        <xsl:if test="(@before-extent)">
          <xsl:attribute name="extent">
            <xsl:value-of select="@before-extent"/>
          </xsl:attribute>
        </xsl:if>
      ...
      <fo:region-after>
        ...
        <xsl:if test="(@after-extent)">
          <xsl:attribute name="extent">
            <xsl:value-of select="@after-extent"/>
          </xsl:attribute>
        </xsl:if>
